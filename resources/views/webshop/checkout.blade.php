...
<div>
    ...
    <div class="shipping_address">
        ...
        @forelse($addresses as $shipping)
            ...
            <div>   
                <input type="radio" name="shipping_address_id" value="sd">{{ $shipping->zipcode }} {{ $shipping->city }} {{ $shipping->street }} {{ $shipping->street_number }}
    ...
    <div class="billing_address">
        ...
        @forelse($addresses as $billing)
            ...
            <div>   
                <input type="radio" name="billing_address_id" value="sd">{{ $billing->zipcode }} {{ $billing->city }} {{ $billing->street }} {{ $billing->street_number }}
    ...
    <strong><a href="{{route('getdeleteaddress',['address_id'=>$billing->id])}}" class="text-danger">Törlés</a></strong>
        ...
        @endforelse
        <div>   
            <a href="#" id="newBilling"><input type="radio" name="address_id" value="sd">Új szállítási cím</a>
        </div> 
